...
class ReversibleConstructor<T extends AnyFunc> extends Function {
  static readonly apply = apply;
  static readonly embed = embed;
 ...
 * );
 */
interface ReversibleConstructor<T extends AnyFunc> extends AnyFunc {
  [symbol]: Reversed<this>;
  __proto__?: ReversibleConstructor<T>;
}
export default ReversibleConstructor;
...
export function embed<T extends AnyFunc>(target: T, fn: Reversed<T>) {
  return Object.assign(target, { [symbol]: fn }) as Reversible<T>;
}
 ...
 */
export function extract<T extends AnyFunc>(target: Tagged<T>): T {
 ...
 */
export function flip<T extends AnyFunc>(target: Tagged<T>): T {
